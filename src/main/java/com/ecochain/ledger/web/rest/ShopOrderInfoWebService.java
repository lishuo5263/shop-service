        ...
        try {
            ...
            if (shopOrderGood != null && shopOrderGood.get(0).getCsessionid().length() >= 32) {
                if ("0".equals(shopOrderGood.get(0).getIsPromote())) {  //正常商品下单
                    ...
                    shopOrderGood.get(0).setData(new StringBuffer(shopOrderGoods.substring(0,shopOrderGoods.length()-1)).append(",\"orderNo\":\""+shopOrderGood.get(0).getOrderNo()+"\"").append(",\"user_name\":\""+shopOrderGood.get(0).getUserName()+"\"").append(",\"goods_name\":\""+shopOrderGood.get(0).getGoodsName()+"\"").append(",\"bussType\":\"insertOrder\"}").toString());
